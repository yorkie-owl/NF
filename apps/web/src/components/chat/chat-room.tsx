...
export default function ChatRoom({ roomId, title }: Props) {
  ...
  return (
    <div className="flex flex-col h-[828px]" style={{ background: 'linear-gradient(to bottom, #FFF5F7 0%, #FDF6F8 50%, #FAFAFA 100%)' }}>
      ...
      {/* 输入区 */}
      <div className="shrink-0 px-4 py-3 border-t border-pink-50 bg-transparent">
