...
import { Bell, ChefHat, Heart, User as UserIcon, Utensils } from 'lucide-react';
  ...
  return (
    <div className="mx-auto max-w-md px-5 pb-6 pt-6">
      ...
      <div className="flex items-start justify-between">
        <h1 className="text-[24px] font-bold text-neutral-900">邻食</h1>
        <button
          type="button"
          aria-label="通知中心"
      ...
      <div className="mt-4">
        {invite.data ? (
          ...
          <div className="rounded-2xl bg-gradient-invite p-5 text-[12px] text-neutral-700/80">
            加载邀请码中…
          </div>
        )}
      </div>
      ...
      <div className="mt-6 flex flex-col gap-3">
        <Link href="/profile/edit" className="block">
          <Button variant="gradient" size="xl" full>
